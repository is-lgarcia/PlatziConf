...
import com.luisg.conf.model.Ubication
...
class UbicationDetailDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        txtDetailUbicationPlace.text = ubication.name
        txtDetailUbicationDirection.setText(ubication.address)
        txtDetailUbicationPhone.setText(ubication.phone)
        txtDetailUbicationWebSite.setText(ubication.website)

        txtDetailUbicationPhone.setOnClickListener {
            val intent = Intent(Intent.ACTION_DIAL).apply {
                data = Uri.parse("tel:${ubication.phone}")
            }
            startActivity(intent)
        }
        txtDetailUbicationWebSite.setOnClickListener {
